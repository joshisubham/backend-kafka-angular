...
docker pull subhamjoshi466/api-gateway:0.0.1-SNAPSHOT
docker pull subhamjoshi466/product-service:0.0.1-SNAPSHOT
docker pull subhamjoshi466/order-service:0.0.1-SNAPSHOT
docker pull subhamjoshi466/inventory-service:0.0.1-SNAPSHOT
docker pull subhamjoshi466/notification-service:0.0.1-SNAPSHOT
...
kind load docker-image -n microservices subhamjoshi466/api-gateway:0.0.1-SNAPSHOT
kind load docker-image -n microservices subhamjoshi466/product-service:0.0.1-SNAPSHOT
kind load docker-image -n microservices subhamjoshi466/order-service:0.0.1-SNAPSHOT
kind load docker-image -n microservices subhamjoshi466/inventory-service:0.0.1-SNAPSHOT
kind load docker-image -n microservices subhamjoshi466/notification-service:0.0.1-SNAPSHOT
